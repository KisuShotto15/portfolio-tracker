...
var NOTE_ICONS=[
  ...
  { keywords:['verduras','verdura','vegetales','vegetal','hortalizas','platano','platanos','tomate','tomates','cebolla','cebollas','papa','papas','zanahoria','zanahorias','lechuga','aguacate','pimenton','yuca','ajo','frutas','fruta','verduleria','fruteria'], src:'/icon-veggies.png?v=1', zoom:1 },
];
